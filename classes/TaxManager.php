<?php
// classes/TaxManager.php

if (!class_exists('TaxManager')) {
    ...
    class TaxManager {
        ...
        public function getTaxSlabs() {
            try {
                // Corrected SQL to match the schema
                $sql = "SELECT id, slab_name, minimum_income, maximum_income, tax_base_amount, excess_tax_percentage, country_code FROM tax_slabs ORDER BY minimum_income ASC";
        ...
        public function calculateEstimatedYearlyTax($annualIncome, $countryCode = 'PK') {
            try {
                $sql = "SELECT id, slab_name, minimum_income, maximum_income, tax_base_amount, excess_tax_percentage FROM tax_slabs WHERE country_code = :country_code ORDER BY minimum_income ASC";
                ...
                foreach ($taxSlabs as $slab) {
                    ...
                    $fixed = (float) $slab['tax_base_amount'];
